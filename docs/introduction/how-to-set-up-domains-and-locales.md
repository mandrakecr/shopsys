...
Alphabetical sorting on frontend uses ElasticSearch and it's [ICU analysis plugin](https://www.elastic.co/guide/en/elasticsearch/plugins/6.3/analysis-icu.html).
